...
import { classifyCrash, readBootState, readIncident, runDoctor, worstLevel, writeBootState } from "./doctor.js";
import { renderJson, renderReport } from "./report.js";
import { defaultStateRoot } from "./launcher.js";
import { packageRootDir } from "./plane.js";
import { pathNoticeIsNews, writeShim } from "./shim.js";
 ...
 */
function installLauncher(stateRoot) {
    ...
    if (shim.pathAdvice === undefined || !pathNoticeIsNews(stateRoot, shim.onPath))
        return;
 ...
 */
function installBootHandshake(ctx, stateRoot) {
